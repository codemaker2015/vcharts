...
import com.vsoft.mpchartexample.custom.RadarMarkerView;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.viewGithub: {
                ...
                i.setData(Uri.parse("https://github.com/PhilJay/MPAndroidChart/blob/master/MPChartExample/src/com/vsoft/mpchartexample/RadarChartActivity.java"));
                startActivity(i);
                break;
            }
