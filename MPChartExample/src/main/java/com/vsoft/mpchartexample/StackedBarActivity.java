...
import com.vsoft.mpchartexample.custom.MyValueFormatter;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.viewGithub: {
                ...
                i.setData(Uri.parse("https://github.com/PhilJay/MPAndroidChart/blob/master/MPChartExample/src/com/vsoft/mpchartexample/StackedBarActivity.java"));
                startActivity(i);
                break;
            }
